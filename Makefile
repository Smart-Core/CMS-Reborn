...
db-schema-drop:
	docker-compose run --rm php bin/console doctrine:schema:drop --force --full-database

db-schema-update:
	docker-compose run --rm php bin/console doctrine:schema:update --force

db-du:
	docker-compose run --rm php bin/console db:du

db-re:
	docker-compose run --rm php bin/console db:re

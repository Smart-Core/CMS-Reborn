...
use SmartCore\CMSBundle\Controller\AbstractAdminController;
use SmartCore\CMSBundle\Controller\AbstractModuleNodeController;
use SmartCore\CMSBundle\Controller\ModuleAdminControllerInterface;
use SmartCore\CMSBundle\Controller\ModuleNodeControllerInterface;
...
class ModuleManager
{
    ...
    /**
     * @var \SmartCore\CMSBundle\Module\ModuleBundle[]
     */
    protected $modules = [];
     ...
     *
     * @return \SmartCore\CMSBundle\Module\ModuleBundle[]
     */
     ...
     * @param string $name
     *
     * @return \SmartCore\CMSBundle\Module\ModuleBundle|null
     */
